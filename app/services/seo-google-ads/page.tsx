...
const seoServices = [
    {
        ...
        description: "Improve your website's visibility and rankings on search engines organically.",
        icon: Search,
        features: ["Keyword Research", "On-Page SEO", "Technical SEO", "Link Building"],
    },
    {
        title: "Google Ads Management",
        description: "Strategic Google Ads campaigns to drive targeted traffic and conversions.",
        icon: Target,
        features: ["Campaign Setup", "Keyword Optimization", "Ad Creation", "Bid Management"],
    },
    {
        title: "Local SEO",
        description: "Optimize your online presence for local search results and Google My Business.",
        icon: TrendingUp,
        features: ["Local Listings", "Google My Business", "Local Citations", "Review Management"],
    },
    {
        title: "Content Optimization",
        description: "Optimize your content to rank higher and attract more organic traffic.",
        icon: Zap,
        features: ["Content Strategy", "SEO Writing", "Content Updates", "Content Marketing"],
    },
    {
        title: "Performance Tracking",
        description: "Comprehensive analytics and reporting to track your SEO and PPC performance.",
        icon: BarChart3,
        features: ["Rank Tracking", "Traffic Analysis", "Conversion Tracking", "ROI Reporting"],
    },
    {
        title: "Competitor Analysis",
        description: "Analyze your competitors' strategies to gain a competitive advantage.",
        icon: Rocket,
        features: ["Competitor Research", "Keyword Gap Analysis", "Strategy Development", "Market Insights"],
    },
];
                ...
                <section className="relative pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 md:pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        <div 
                            ...
                            style={{
                                backgroundImage: "url('https://images.unsplash.com/photo-1432888622747-4eb9a8f2c92c?w=1920&q=80')"
                            }}
                        ></div>
                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center relative z-10">
                        <FadeIn>
                            <div className="text-left">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-stone-900 mb-6 sm:mb-8 leading-tight">
                                    SEO & <span className="text-amber-600">Google Ads</span>
                                </h1>
                                <p className="text-lg sm:text-xl md:text-2xl text-stone-600 mb-8 sm:mb-10 leading-relaxed">
                                    SEO(Search Engine Optimization) is one of the important factors in your business website. If you're website is good and your audience doesn't know about the brand then SEO will help you to reach to your targeted customers.
                                </p>
                                <Link
                                    href="/contact"
                        ...
                        <FadeIn delay={200}>
                            <div className="relative w-full h-full min-h-[400px] sm:min-h-[500px] md:min-h-[600px] rounded-2xl overflow-hidden">
                                <Image
                                    src="https://images.unsplash.com/photo-1432888622747-4eb9a8f2c92c?w=800&q=80"
                                    alt="SEO & Google Ads"
                                    fill
                                    className="rounded-2xl object-cover"
                                    unoptimized
                                />
                                <div className="absolute inset-0 bg-gradient-to-br from-yellow-600/10 to-transparent rounded-2xl"></div>
                            </div>
                        </FadeIn>
                    </div>
                </section>
                        ...
                        <FadeIn>
                            <div className="text-center mb-12 sm:mb-16">
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 sm:mb-6">
                                    Our SEO & Google Ads <span className="text-amber-600">Services</span>
                                </h2>
                                <p className="text-lg sm:text-xl text-stone-600 max-w-3xl mx-auto">
                                    Comprehensive SEO and Google Ads solutions to drive targeted traffic and conversions
                                </p>
                            </div>
                        </FadeIn>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <FadeIn>
                            ...
                            <p className="text-lg sm:text-xl text-stone-300 mb-8 sm:mb-10 max-w-2xl mx-auto">
                                Let's discuss how our SEO and Google Ads services can drive more traffic to your website
                            </p>
