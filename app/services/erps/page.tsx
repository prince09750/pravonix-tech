...
const erpServices = [
    {
        ...
        description: "Complete ERP system implementation tailored to your business processes.",
        icon: Settings,
        features: ["System Setup", "Process Mapping", "Data Migration", "User Training"],
    },
    {
        title: "Business Process Integration",
        description: "Seamlessly integrate your back and front office applications for unified operations.",
        icon: Workflow,
        features: ["System Integration", "Data Synchronization", "Workflow Automation", "API Development"],
    },
    {
        title: "Custom ERP Development",
        description: "Build custom ERP solutions designed specifically for your business needs.",
        icon: Database,
        features: ["Custom Modules", "Business Logic", "Scalable Architecture", "Cloud Deployment"],
    },
    {
        title: "ERP Analytics & Reporting",
        description: "Advanced analytics and reporting capabilities to make data-driven decisions.",
        icon: BarChart3,
        features: ["Real-time Dashboards", "Custom Reports", "Data Visualization", "Business Intelligence"],
    },
    {
        title: "ERP Maintenance & Support",
        description: "Ongoing maintenance, updates, and support to keep your ERP running smoothly.",
        icon: Shield,
        features: ["System Updates", "Bug Fixes", "Performance Tuning", "24/7 Support"],
    },
    {
        title: "ERP Migration",
        description: "Migrate from legacy systems to modern ERP solutions with minimal disruption.",
        icon: Rocket,
        features: ["Data Migration", "System Migration", "Training & Support", "Go-live Support"],
    },
];
                        ...
                        <FadeIn>
                            <div className="text-left">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-stone-900 mb-6 sm:mb-8 leading-tight">
                                    ERP <span className="text-amber-600">Solutions</span>
                                </h1>
                        ...
                        <FadeIn>
                            <div className="text-center mb-12 sm:mb-16">
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 sm:mb-6">
                                    Our ERP <span className="text-amber-600">Services</span>
                                </h2>
