...
const securityServices = [
    {
        ...
        icon: Shield,
        features: ["Vulnerability Assessment", "Security Audits", "Risk Analysis", "Remediation Guidance"],
    },
    {
        title: "Data Encryption",
        description: "End-to-end encryption solutions to protect sensitive data at rest and in transit.",
        icon: Lock,
        features: ["Data at Rest Encryption", "Data in Transit Encryption", "Key Management", "Compliance"],
    },
    {
        title: "Security Monitoring",
        description: "24/7 security monitoring and threat detection to protect your digital assets.",
        icon: Eye,
        features: ["Threat Detection", "Intrusion Detection", "Real-time Monitoring", "Incident Response"],
    },
    {
        title: "Security Compliance",
        description: "Ensure compliance with industry standards and regulations (SOC 2, ISO 27001, GDPR).",
        icon: FileCheck,
        features: ["Compliance Audits", "Policy Development", "Security Frameworks", "Certification Support"],
    },
    {
        title: "Access Control",
        description: "Implement robust access control mechanisms to protect your systems and data.",
        icon: Key,
        features: ["Identity Management", "Multi-factor Authentication", "Role-Based Access", "Single Sign-On"],
    },
    {
        title: "Security Consulting",
        description: "Expert security consulting to develop and implement comprehensive security strategies.",
        icon: Server,
        features: ["Security Strategy", "Risk Assessment", "Security Architecture", "Best Practices"],
    },
];
                        ...
                        <FadeIn>
                            <div className="text-left">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-stone-900 mb-6 sm:mb-8 leading-tight">
                                    Cybersecurity & <span className="text-amber-600">Compliance</span>
                                </h1>
                                <p className="text-lg sm:text-xl md:text-2xl text-stone-600 mb-8 sm:mb-10 leading-relaxed">
                                    Bank-grade security protocols. We implement rigorous penetration testing and encryption to protect your digital assets.
                                </p>
                                <Link
                                    href="/contact"
                        ...
                        <FadeIn>
                            <div className="text-center mb-12 sm:mb-16">
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 sm:mb-6">
                                    Our Security <span className="text-amber-600">Services</span>
                                </h2>
                                <p className="text-lg sm:text-xl text-stone-600 max-w-3xl mx-auto">
                                    Comprehensive cybersecurity and compliance solutions to protect your digital assets
                                </p>
                            </div>
                        </FadeIn>
