...
const marketingServices = [
    {
        ...
        description: "Strategic paid advertising campaigns across Google, Facebook, and other platforms.",
        icon: Megaphone,
    ...
    },
    {
        ...
        icon: TrendingUp,
        features: ["Blog Writing", "Content Strategy", "Video Content", "Infographics"],
    },
    {
        title: "Email Marketing",
        description: "Targeted email campaigns to nurture leads and drive conversions.",
        icon: Mail,
        features: ["Email Campaigns", "Automation", "Newsletters", "Lead Nurturing"],
    },
    {
        title: "Analytics & Reporting",
        description: "Comprehensive analytics to track performance and optimize your marketing efforts.",
        icon: BarChart3,
        features: ["Performance Tracking", "ROI Analysis", "Custom Reports", "Data Insights"],
    },
    {
        title: "Marketing Strategy",
        description: "Data-driven marketing strategies tailored to your business goals.",
        icon: Target,
        features: ["Strategy Development", "Audience Research", "Campaign Planning", "Budget Optimization"],
    },
    {
        title: "Conversion Optimization",
        description: "Optimize your website and campaigns to maximize conversions and ROI.",
        icon: Rocket,
        features: ["A/B Testing", "Landing Page Optimization", "Funnel Analysis", "Conversion Rate"],
    },
];
                        ...
                        <FadeIn>
                            <div className="text-left">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-stone-900 mb-6 sm:mb-8 leading-tight">
                                    Digital <span className="text-amber-600">Marketing</span>
                                </h1>
                                <p className="text-lg sm:text-xl md:text-2xl text-stone-600 mb-8 sm:mb-10 leading-relaxed">
                                    Nowadays digital marketing is one of the popular ways to boost or promote brands & products through the internet and other digital channels.
                                </p>
                                <Link
                                    href="/contact"
                        ...
                        <FadeIn delay={200}>
                            <div className="relative w-full h-full min-h-[400px] sm:min-h-[500px] md:min-h-[600px] rounded-2xl overflow-hidden">
                                <Image
                                    ...
                                    unoptimized
                                />
                                <div className="absolute inset-0 bg-gradient-to-br from-pink-600/10 to-transparent rounded-2xl"></div>
                            </div>
                        </FadeIn>
                    </div>
                </section>
                        ...
                        <FadeIn>
                            <div className="text-center mb-12 sm:mb-16">
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 sm:mb-6">
                                    Our Digital Marketing <span className="text-amber-600">Services</span>
                                </h2>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <FadeIn>
                            ...
                            <p className="text-lg sm:text-xl text-stone-300 mb-8 sm:mb-10 max-w-2xl mx-auto">
                                Let's discuss how our digital marketing services can boost your brand
                            </p>
