...
const socialMediaServices = [
    {
        ...
        description: "Comprehensive social media strategies to achieve your business objectives.",
        icon: TrendingUp,
        features: ["Strategy Development", "Content Planning", "Audience Targeting", "Platform Selection"],
    },
    {
        title: "Content Creation",
        description: "Engaging content that resonates with your audience and drives engagement.",
        icon: Camera,
        features: ["Visual Content", "Video Production", "Copywriting", "Graphics Design"],
    },
    {
        title: "Community Management",
        description: "Build and nurture your online community with active engagement and support.",
        icon: MessageCircle,
        features: ["Engagement Management", "Customer Support", "Community Building", "Response Management"],
    },
    {
        title: "Social Advertising",
        description: "Targeted paid campaigns on social platforms to reach your ideal customers.",
        icon: Share2,
    ...
    },
    {
        ...
        icon: Users,
        features: ["Influencer Outreach", "Campaign Management", "Partnership Development", "ROI Tracking"],
    },
    {
        title: "Analytics & Reporting",
        description: "Track performance and measure ROI with comprehensive social media analytics.",
        icon: Rocket,
        features: ["Performance Metrics", "Engagement Analysis", "ROI Reporting", "Growth Tracking"],
    },
];
                        ...
                        <FadeIn>
                            <div className="text-left">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-stone-900 mb-6 sm:mb-8 leading-tight">
                                    Social Media <span className="text-amber-600">Marketing</span>
                                </h1>
                                <p className="text-lg sm:text-xl md:text-2xl text-stone-600 mb-8 sm:mb-10 leading-relaxed">
                                    More than 3 billion people are connected through social platforms so it is important to reach out to our consumers who are on social platforms. Social media marketing helps you to connect those people worldwide.
                                </p>
                                <Link
                                    href="/contact"
                        ...
                        <FadeIn delay={200}>
                            <div className="relative w-full h-full min-h-[400px] sm:min-h-[500px] md:min-h-[600px] rounded-2xl overflow-hidden">
                                <Image
                                    ...
                                    unoptimized
                                />
                                <div className="absolute inset-0 bg-gradient-to-br from-cyan-600/10 to-transparent rounded-2xl"></div>
                            </div>
                        </FadeIn>
                    </div>
                </section>
                        ...
                        <FadeIn>
                            <div className="text-center mb-12 sm:mb-16">
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 sm:mb-6">
                                    Our Social Media <span className="text-amber-600">Services</span>
                                </h2>
                                <p className="text-lg sm:text-xl text-stone-600 max-w-3xl mx-auto">
                                    Comprehensive social media marketing solutions to connect with your audience
                                </p>
                            </div>
                        </FadeIn>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <FadeIn>
                            ...
                            <p className="text-lg sm:text-xl text-stone-300 mb-8 sm:mb-10 max-w-2xl mx-auto">
                                Let's discuss how our social media marketing services can grow your brand
                            </p>
