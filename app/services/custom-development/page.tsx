...
const customServices = [
    {
        ...
        icon: Code,
        features: ["Unique Design", "Custom Functionality", "Scalable Architecture", "Performance Optimized"],
    },
    {
        title: "UI/UX Design",
    ...
    },
    {
        ...
        description: "Complete end-to-end development from frontend to backend with modern technologies.",
        icon: Layers,
    ...
    },
    {
        ...
        description: "Enhance your website's speed, SEO, and user experience for better results.",
        icon: Zap,
        features: ["Speed Optimization", "SEO Enhancement", "Mobile Optimization", "Security"],
    },
    {
                        ...
                        <FadeIn>
                            <div className="text-left">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-stone-900 mb-6 sm:mb-8 leading-tight">
                                    Custom <span className="text-amber-600">Development</span>
                                </h1>
                        ...
                        <FadeIn>
                            <div className="text-center mb-12 sm:mb-16">
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 sm:mb-6">
                                    Our Custom Development <span className="text-amber-600">Services</span>
                                </h2>
                                <p className="text-lg sm:text-xl text-stone-600 max-w-3xl mx-auto">
                                    Tailored solutions built from scratch to meet your exact requirements
                                </p>
                            </div>
                        </FadeIn>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <FadeIn>
                            ...
                            <p className="text-lg sm:text-xl text-stone-300 mb-8 sm:mb-10 max-w-2xl mx-auto">
                                Let's discuss how our custom development services can bring your vision to life
                            </p>
