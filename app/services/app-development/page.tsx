...
const appServices = [
    {
        ...
        description: "Native iOS applications built with Swift and SwiftUI for seamless Apple ecosystem integration.",
        icon: Smartphone,
        features: ["Swift & SwiftUI", "App Store Optimization", "Core Data Integration", "Push Notifications"],
    },
    {
        title: "Android App Development",
        description: "Powerful Android apps using Kotlin and Jetpack Compose for modern Android experiences.",
        icon: Smartphone,
        features: ["Kotlin & Java", "Material Design", "Google Play Integration", "Firebase Integration"],
    },
    {
        title: "Cross-Platform Development",
        description: "Build once, deploy everywhere with React Native and Flutter for maximum reach.",
        icon: Globe,
        features: ["React Native", "Flutter", "Code Reusability", "Native Performance"],
    },
    {
    ...
    },
    {
        ...
        description: "Complete assistance with app store submission, optimization, and launch strategies.",
        icon: Rocket,
        features: ["Store Submission", "ASO Optimization", "Launch Strategy", "Review Management"],
    },
];
                ...
                <section className="relative pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 md:pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        <div 
                            ...
                            style={{
                                backgroundImage: "url('https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1920&q=80')"
                            }}
                        ></div>
                        ...
                        <FadeIn>
                            <div className="text-left">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-stone-900 mb-6 sm:mb-8 leading-tight">
                                    App <span className="text-amber-600">Development</span>
                                </h1>
                        ...
                        <FadeIn>
                            <div className="text-center mb-12 sm:mb-16">
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-stone-900 mb-4 sm:mb-6">
                                    Our App Development <span className="text-amber-600">Services</span>
                                </h2>
                                <p className="text-lg sm:text-xl text-stone-600 max-w-3xl mx-auto">
                                    Comprehensive mobile application solutions tailored to your business needs
                                </p>
                            </div>
                        </FadeIn>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <FadeIn>
                            ...
                            <p className="text-lg sm:text-xl text-stone-300 mb-8 sm:mb-10 max-w-2xl mx-auto">
                                Let's discuss how our app development services can transform your business
                            </p>
